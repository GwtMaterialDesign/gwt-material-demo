...
public class GlobalFunctionalityTest extends BaseSeleniumTest {
    ...
    protected void checkNavigationFeature() {}

    protected void checkChangeThemes() {}

    protected void checkAppFooter() {}
