...
public class SwipeablePresenter extends Presenter<SwipeablePresenter.MyView, SwipeablePresenter.MyProxy> {
    ...
    protected void onReveal() {
        super.onReveal();
        SetPageTitleEvent.fire("Swipeable", "A panel that allows any of its nested children to be swiped away. This component is only applicable to touch screen devices.", "addins/swipeable/SwipeableView", "", this);
    }
}
