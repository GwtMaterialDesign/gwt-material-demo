...
public class FrozenDataTablePresenter extends Presenter<FrozenDataTablePresenter.MyView, FrozenDataTablePresenter.MyProxy> {
    @Inject
    FrozenDataTablePresenter(
            EventBus eventBus,
            MyView view,
            MyProxy proxy) {
    ...
    @NameToken(NameTokens.frozenDataTable)
    @ProxyCodeSplit
    interface MyProxy extends ProxyPlace<FrozenDataTablePresenter> {
    }
}
