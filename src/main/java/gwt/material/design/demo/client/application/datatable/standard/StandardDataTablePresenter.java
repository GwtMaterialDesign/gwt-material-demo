...
public class StandardDataTablePresenter extends Presenter<StandardDataTablePresenter.MyView, StandardDataTablePresenter.MyProxy> {
    interface MyView extends View {
    }

    @NameToken(NameTokens.standardDataTable)
    @ProxyCodeSplit
    interface MyProxy extends ProxyPlace<StandardDataTablePresenter> {
    }
