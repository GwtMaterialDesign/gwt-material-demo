package gwt.material.design.demo.client.application.pwa.installable;
...
public class InstallablePresenter extends Presenter<InstallablePresenter.MyView, InstallablePresenter.MyProxy> {
    interface MyView extends View {
    }

    @NameToken(NameTokens.installable)
    @ProxyCodeSplit
    interface MyProxy extends ProxyPlace<InstallablePresenter> {
    }

    @Inject
    InstallablePresenter(
            EventBus eventBus,
            MyView view,
            MyProxy proxy) {
