...
public class RatingPresenter extends Presenter<RatingPresenter.MyView, RatingPresenter.MyProxy> {
    ...
    protected void onReveal() {
        super.onReveal();
        SetPageTitleEvent.fire("Rating", " MaterialRating is the component used by the 5-star rating system, for example, allowing users to easily express their opinion about a product, review, video and so on. ", this);
    }
