...
public class GridPresenter extends Presenter<GridPresenter.MyView, GridPresenter.MyProxy> {
    ...
    protected void onReveal() {
        ...
        SetPageTitleEvent.fire("Grid",
                "We are using a standard 12 column fluid responsive grid system.The grid helps you layout your page in an ordered, easy fashion", "", "https://material.io/guidelines/components/grid-lists.html", this);
    }
}
