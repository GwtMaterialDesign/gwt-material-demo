...
public class DataHelper {
    ...
    public static List<Version> getAllVersions() {
        ...
        versions.add(new Version("2.1", "Work in Progress", Version.VersionLink.CORE_2_1.getName(), Version.VersionLink.ADDINS_2_1.getName(), Version.VersionLink.THEME_2_1.getName(), Version.VersionLink.JQUERY_2_1.getName(), Version.VersionLink.TABLE_2_1.getName(), Color.INDIGO));
