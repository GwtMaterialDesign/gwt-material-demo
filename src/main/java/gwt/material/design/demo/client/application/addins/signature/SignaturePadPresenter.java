...
public class SignaturePadPresenter extends Presenter<SignaturePadPresenter.MyView, SignaturePadPresenter.MyProxy>
    ...
    @NameToken(NameTokens.signaturePad)
    @ProxyCodeSplit
    ...
    protected void onReveal() {
        super.onReveal();
        SetPageTitleEvent.fire("Signature Pad", "HTML5 canvas based smooth signature drawing", "addins/signature/SignaturePadView", "", this);
    }

    @Override
    public void onContentPush(ContentPushEvent event) {
        getView().resizeSignaturePad();
    }
}
